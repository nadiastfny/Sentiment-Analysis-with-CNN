            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Cek Kalimat Review</h1>
                    </div>
  <!-- Area Chart -->
                        <div class="col-xl-20 col-lg-10">
                            <div class="card shadow mb-4">
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Sentiment Polaritas</h6>
                                </div>
                                <!-- Card Body  -->  
                                <div class="card-body">
                                    <div class="chart-area">
                                        <form action="/ujitext" method="POST">
                                            <textarea name="text" class="form-control" placeholder="Kalimat review ....." id="floatingTextarea2" style="height: 100px"></textarea><br>
                                            <button type="submit" class="btn btn-primary">Cek Sentiment Polaritas!</button>
                                        </form>
                                    </div>
