            ...
            <div id="content">
                ...
                <div class="row">
                    <ul class="breadcrumb" width="100%">
                        <li class="breadcrumb-item"><a href="{{url_for('addUji') }}" data-toggle="modal" data-target="#addModal">Tambah Data</a></li>
                    </ul>
                    <!-- <div class="btn-group">
                                ...
                                <table class="table css-serial">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="/hapusuji/{{ row.0 }},{{ row.1 }}" class="btn btn-outline-danger" onclick="return confirm('Yakin ingin hapus?')">Hapus</a></td>
                                        </tr>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="chart-area">
                                                            <form action="{{ url_for('editUji') }}" method="POST">
                                                                <input type="hidden" name="id_tes" value="{{ row.0 }}">
